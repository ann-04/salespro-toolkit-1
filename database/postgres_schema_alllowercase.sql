-- PostgreSQL Schema - ALL LOWERCASE (simplest approach)
...
ALTER TABLE users ADD CONSTRAINT fk_users_bu FOREIGN KEY (businessunitid) REFERENCES businessunits(id) ON DELETE SET NULL;
...
SELECT 'Schema created! Login: admin@salespro.com / Admin@123' as message;
